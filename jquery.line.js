...
(function($) {
  ...
  var helpers = {
    createLine: function(x1, y1, x2, y2, options, existingLine){
                  ...
                  var line = existingLine || document.createElement("div");
  ...
  $.fn.line = function( x1, y1, x2, y2, options, line, callback) {
                return $(this).each(function(){
                  options = $.extend({}, $.fn.line.defaults, options);

                  var el = helpers.createLine(x1,y1,x2,y2,options, line);
                  $(this).append(el);
